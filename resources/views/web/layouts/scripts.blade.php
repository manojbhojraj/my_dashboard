...
<script src="{{ asset('web/vendors/jvectormap/jquery-jvectormap.min.js')}}"></script>
<script src="{{ asset('web/vendors/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
<script src="{{ asset('web/vendors/owl-carousel-2/owl.carousel.min.js')}}"></script>
